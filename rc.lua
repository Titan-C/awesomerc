...
if "klappbier" == hostname then
    awful.spawn.with_shell("xrandr --output eDP-1 --primary --mode 1920x1080 --pos 2560x1080 --rotate normal --output DP-1-2 --mode 2560x1440 --pos 0x0 --rotate normal --output DP-1-3 --mode 1920x1080 --pos 2560x0 --rotate normal")
end
