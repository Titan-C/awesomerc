...
if "klappbier" == hostname then
    awful.spawn.with_shell("xrandr --output eDP-1 --primary --mode 1920x1080 --pos 1584x1440 --rotate normal --output DP-1-2 --mode 2560x1440 --pos 2560x0 --rotate normal --output HDMI-2 --off --output HDMI-1 --off --output DP-1 --off --output DP-1-3 --off --output DP-2 --off --output DP-1-1 --mode 2560x1440 --pos 0x0 --rotate normal")
...
local globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn(tools.terminal) end,
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function ()
              ...
              {description = "Raise Volume 5%", group = "Audio"}),
    awful.key({ }, "XF86AudioLowerVolume", function ()
                    awful.spawn("amixer set Master 5%-",false) end,
              {description = "Lower Volume 5%", group = "Audio"}),
